...
`${GOPATH}/src/github.com/dedi27/compellentbeat`
...
```
git remote set-url origin https://github.com/dedi27/compellentbeat
...
in the same directory with the name compellentbeat.
...
```
./compellentbeat -c compellentbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/dedi27/compellentbeat
git clone https://github.com/dedi27/compellentbeat ${GOPATH}/src/github.com/dedi27/compellentbeat
```
